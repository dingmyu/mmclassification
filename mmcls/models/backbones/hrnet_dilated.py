# fuse directly and downsample stride=dilation=pad
...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = conv3x3(inplanes, planes, stride, padding=stride, dilation=stride)
...
class HighResolutionNetDia(nn.Module):
    ...
    def __init__(self,
                 ...
                 ** kwargs):
        super(HighResolutionNetDia, self).__init__()
